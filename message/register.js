...
let ppimg = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/24fa902ead26340f3df2c.png')
...
conn.sendButDoc(m.chat, teks,copyright,null, butprofile, options1)
fs.unlinkSync(foto)
});
